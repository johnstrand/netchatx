...
public class LinkTests
{
    ...
    public void LinkParser_SingleHttpAndHttpsUrls_ExtractedProperly()
    {
        ...
        Assert.Equal("https://github.com/johnstrand/netchatx", segments[1].Text);
    ...
    public void LinkParser_MailtoAndXmpp_ExtractedProperly()
    {
        ...
        var links = segments.Where(s => s.IsLink).ToList();
        Assert.Equal(2, links.Count);
        Assert.Equal("mailto:support@netchatx.org", links[0].Text);
        Assert.Equal("xmpp:team@conference.netchatx.org?join", links[1].Text);
    }
    ...
    public void HyperlinkTextBlock_WithLinks_PopulatesInlinesAndButtons()
    {
        ...
        var control = new HyperlinkTextBlock
        {
            ...
            Text = "Check https://github.com/johnstrand/netchatx please!"
        };
        ...
        Assert.Equal("https://github.com/johnstrand/netchatx", tbContent.Text);

        // Perform click programmatically
        button.RaiseEvent(new Avalonia.Interactivity.RoutedEventArgs(Button.ClickEvent));
        Assert.Equal("https://github.com/johnstrand/netchatx", clickedUrl);
    ...
    public void MessageBubbleViewModel_ExtractLinks_DetectsUrlsAndSetsProperties()
    {
        var msg = new ChatMessage
        {
            ...
            Body = "Check out https://github.com/johnstrand/netchatx and www.google.com for more info.",
        ...
        Assert.Equal("https://github.com/johnstrand/netchatx", vm.Links[0]);
