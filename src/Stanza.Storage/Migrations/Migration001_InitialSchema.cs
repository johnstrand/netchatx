...
public sealed class Migration001_InitialSchema : DatabaseMigration
{
    public override int Version => 1;
    public override string Description => "Create initial database schema";
    ...
    {
        ExecuteNonQuery(connection, transaction, InitialSchemaSql);
    }
}
